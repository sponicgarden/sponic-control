      ...
      body: JSON.stringify({
        ...
        html: `
          ...
          <div style="background: #f0f7ff; border-radius: 8px; padding: 20px; margin: 20px 0;">
            ...
            <p style="margin-bottom: 0;"><a href="https://sponicgarden.com/residents/profile.html" style="display: inline-block; background: #3d8b7a; color: #fff; padding: 10px 24px; border-radius: 6px; text-decoration: none; font-weight: 600;">Complete Your Profile</a></p>
          </div>
...
https://sponicgarden.com/residents/profile.html
...
async function sendVehicleRegistrationEmail(
  ...
  const profileUrl = 'https://sponicgarden.com/residents/profile.html#vehicles';
