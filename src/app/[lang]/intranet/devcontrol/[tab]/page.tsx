...
import { DevControlTabContent } from "@/components/devcontrol/tab-content";

export function generateStaticParams() {
  const params: { lang: string; tab: string }[] = [];
  for (const locale of INTRANET_LOCALES) {
    for (const tab of ALL_TAB_SLUGS.devcontrol) {
...
export default function DevControlTabPage() {
  return <DevControlTabContent />;
}
